...
const Sidebar = ({ openSidebar }: SidebarProps) => {
  return (
    <div
      className={`h-full relative w-[240px] bg-[#f4f5f9] flex flex-col p-4 border-r transition-all duration-300 ${
      ...
      <ul className="pt-2">
        <li className="group font-medium text-[#1B2128] text-[1rem] px-2 rounded-lg py-3 flex items-center hover:bg-[#2d5bff] hover:text-white hover:cursor-pointer">
          <Link to="/" className="flex items-center w-full">
            <LucideRows4 className="pr-1 group-hover:text-white text-[#9dacbe]" />
            Agentes
          </Link>
        </li>
        <li className="group font-medium text-[#1B2128] text-[1rem] px-2 rounded-lg py-3 flex items-center hover:bg-[#2d5bff] hover:text-white hover:cursor-pointer">
          <Link to="/create-agent" className="flex items-center w-full">
            <UserRoundPlus className="pr-1 group-hover:text-white text-[#9dacbe]" />
            Criar agente
          </Link>
        </li>
        <li className="group font-medium text-[#1B2128] text-[1rem] px-2 rounded-lg py-3 flex items-center hover:bg-[#2d5bff] hover:text-white hover:cursor-pointer">
        ...
        <li className="group font-medium text-[#1B2128] text-[1rem] px-2 rounded-lg py-3 flex items-center hover:bg-[#2d5bff] hover:text-white hover:cursor-pointer">
          <Link to="/report" className="flex items-center w-full">
            <ScrollText className="pr-1 group-hover:text-white text-[#9dacbe]" />
            Gerar Relatório
          </Link>
        </li>
      </ul>
